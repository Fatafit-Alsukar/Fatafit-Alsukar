...
import { Calendar, User, Tag, ArrowRight, ChevronLeft, Bookmark, Share2, Heart, MessageCircle } from "lucide-react";
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <button
                      ...
                      className="mt-4 flex items-center gap-2 text-indigo-600 hover:text-indigo-700 transition-colors duration-300"
                    >
                      اقرأ المزيد
