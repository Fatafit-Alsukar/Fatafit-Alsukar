...
//         toast.success("يرجى تغيير كلمة المرور المؤقتة.", {
//           duration: 2000,
//           style: {
...
//       <div className="w-full p-4 max-w-xs min-h-screen py-30"> {/* تم تقليل العرض إلى max-w-xs */}
...
//         {/* نموذج تسجيل الدخول */}
//         <div className="bg-white bg-opacity-95 backdrop-blur-sm rounded-3xl shadow-2xl p-6"> {/* تم تقليل padding إلى p-6 */}
